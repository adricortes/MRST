% Post-process the two diffusion runs (paper Fig. 6 style):
% maps of dissolved CO2 (rs) at t = 30 days, D = 0 vs D = 2e-11 m2/s.
set(0, 'defaultfigurevisible', 'off');
outdir = '/tmp/claude-1000/-home-adriano-codes-MRST/ad017599-1c83-453b-a05e-6b33ad5bc00f/scratchpad';

d0 = load(fullfile(outdir, 'diff_D0.mat'));
d2 = load(fullfile(outdir, 'diff_D2e11.mat'));

% Regular grid for interpolation of the PEBI cell data (quasi-2D: y-z plane)
...
print(gcf, fullfile(outdir, 'fig_diffusion_rs30d.png'), '-dpng', '-r130');

% Metrics: dissolved CO2 distribution at t = 30 days
...
fprintf('\nFigure saved: fig_diffusion_rs30d.png\n');
